...
export const sections = [
  ...
  },
  {
    ...
    metric: { big: '3D', cap: '복셀 네비 · 컨텍스트 스티어링 · ORCA' },
    points: [
      '지상 평면을 넘어, 비행체의 3차원 이동·길찾기를 서버에서 처리 (복셀 기반 3D 네비게이션)',
      '장애물 회피 = 컨텍스트 스티어링 — 진행 방향 원뿔로 레이를 샘플링해 막힌 방향을 배제하고 열린 레이 방향으로 조향',
      '에이전트 간 회피 = ORCA(상호 회피) — 씬의 기체들도 실제로 이 방식으로 조향하며 난다 (레이 히트 실측)',
    ],
  },
