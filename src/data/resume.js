...
export const sections = [
  ...
  // ───────── NCSOFT · Miniverse PC / UE5 (2023 — 2024) ─────────
  {
    ...
    points: [
      ...
      '집터 단위 계층적 저장·배치 처리로 수천만 프랍 영속화',
      "3단 공간 분할(집터·청크·셀)·시야 기반 전송 — '총량이 아니라 활성량만 처리'로 트래픽·메모리 관리",
    ],
  },
  {
    id: 'renderopt',
  ...
  // ───────── NCSOFT · AION2 (2016 — 2021) ─────────
  {
    ...
    points: [
      ...
      '전체 ~140명 · 프로그래머 ~40명 기술 디렉팅, 언어(C++→C#)·DB·장르 전환에 대응하며 처음부터 재설계',
      ...
      '서버 충돌·물리 아키텍처, 대규모 NPC 처리·심리스 필드 R&D, 서버 비주얼 디버깅 툴(FieldViewer) 개발',
    ],
  },
  {
    id: 'raycast',
    ...
    metric: { big: '3D', cap: '복셀 네비 · 스티어링 · ORCA' },
    points: [
  ...
  // ───────── 현재 · 마무리 ─────────
  {
    ...
    points: [
      ...
      '사내 코드 유출 없는 로컬 LLM 코딩 스택(llama.cpp) 구축 — 3모델 원클릭 배포',
    ],
    contact: true,
